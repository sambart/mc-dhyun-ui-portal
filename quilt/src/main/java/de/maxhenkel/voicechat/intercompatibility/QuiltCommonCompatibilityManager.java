...
public class QuiltCommonCompatibilityManager extends CommonCompatibilityManager {
    ...
    public String getModVersion() {
        ModContainer modContainer = QuiltLoader.getModContainer(Teleport.MODID).orElse(null);
    ...
    public List<VoicechatPlugin> loadPlugins() {
        return QuiltLoader.getEntrypointContainers(Teleport.MODID, VoicechatPlugin.class).stream().map(EntrypointContainer::getEntrypoint).collect(Collectors.toList());
    }
