...
import com.dhyun.portal.net.JoinGroupPacket;
...
public class EnterPasswordScreen extends VoiceChatScreenBase {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Teleport.MODID, "textures/gui/gui_enter_password.png");
