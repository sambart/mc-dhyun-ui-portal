package com.dhyun.portal.plugins.impl.packets;
...
import com.dhyun.portal.plugins.impl.PositionImpl;
...
public class SoundPacketImpl implements SoundPacket {
    ...
    private final com.dhyun.portal.voice.common.SoundPacket<?> packet;

    public SoundPacketImpl(com.dhyun.portal.voice.common.SoundPacket<?> packet) {
        this.packet = packet;
    }
    ...
    public com.dhyun.portal.voice.common.SoundPacket<?> getPacket() {
        return packet;
    }
