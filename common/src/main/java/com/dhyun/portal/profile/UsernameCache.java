package com.dhyun.portal.profile;
...
public class UsernameCache {
    ...
    public void load() {
        ...
        try (Reader reader = new FileReader(file)) {
            ...
            Teleport.LOGGER.error("Failed to load username cache: {}", e.getMessage());
        }
        if (names == null) {
    ...
    public void save() {
        ...
        try (Writer writer = new FileWriter(file)) {
            ...
            Teleport.LOGGER.error("Failed to save username cache: {}", e.getMessage());
        }
    }
