...
import com.dhyun.portal.voice.common.PingPacket;
...
public class PingManager {
    ...
    public void onPongPacket(PingPacket packet) {
        Teleport.LOGGER.info("Received pong {}", packet.getId());
        ...
        for (Map.Entry<UUID, Ping> pingEntry : timedOut) {
            ...
            if (ping.attempt >= ping.maxAttempts) {
                ...
                try {
                    ...
                    ping.listener.onTimeout(ping.attempt);
                    Teleport.LOGGER.warn("Failed to send ping {} after attempt {}", ping.id, ping.attempt);
                }
            }
        }
    }
    ...
    private class Ping {
        ...
        public void send() throws Exception {
            ...
            Teleport.LOGGER.info("Sent ping {} attempt {}", id, attempt);
        }
    }
