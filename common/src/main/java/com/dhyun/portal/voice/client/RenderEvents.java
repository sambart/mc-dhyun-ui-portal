...
public class RenderEvents {
    ...
    private static final ResourceLocation MICROPHONE_ICON = new ResourceLocation(Teleport.MODID, "textures/icons/microphone.png");
    private static final ResourceLocation WHISPER_MICROPHONE_ICON = new ResourceLocation(Teleport.MODID, "textures/icons/microphone_whisper.png");
    private static final ResourceLocation MICROPHONE_OFF_ICON = new ResourceLocation(Teleport.MODID, "textures/icons/microphone_off.png");
    private static final ResourceLocation SPEAKER_ICON = new ResourceLocation(Teleport.MODID, "textures/icons/speaker.png");
    private static final ResourceLocation WHISPER_SPEAKER_ICON = new ResourceLocation(Teleport.MODID, "textures/icons/speaker_whisper.png");
    private static final ResourceLocation SPEAKER_OFF_ICON = new ResourceLocation(Teleport.MODID, "textures/icons/speaker_off.png");
    private static final ResourceLocation DISCONNECT_ICON = new ResourceLocation(Teleport.MODID, "textures/icons/disconnected.png");
    private static final ResourceLocation GROUP_ICON = new ResourceLocation(Teleport.MODID, "textures/icons/group.png");
    ...
    private void onRenderHUD(PoseStack stack, float tickDelta) {
        ...
        } else if (manager.isMuted() && TeleportClient.CLIENT_CONFIG.microphoneActivationType.get().equals(MicrophoneActivationType.VOICE)) {
        ...
        if (manager.isInGroup() && TeleportClient.CLIENT_CONFIG.showGroupHUD.get()) {
    ...
    private void renderIcon(PoseStack matrixStack, ResourceLocation texture) {
        ...
        int posX = TeleportClient.CLIENT_CONFIG.hudIconPosX.get();
        int posY = TeleportClient.CLIENT_CONFIG.hudIconPosY.get();
        if (posX < 0) {
        ...
        float scale = TeleportClient.CLIENT_CONFIG.hudIconScale.get().floatValue();
