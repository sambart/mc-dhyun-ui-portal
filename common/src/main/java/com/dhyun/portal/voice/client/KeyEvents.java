...
import com.dhyun.portal.gui.VoiceChatScreen;
...
public class KeyEvents {
    ...
    private void handleKeybinds() {
        ...
        if (KEY_HIDE_ICONS.consumeClick()) {
            boolean hidden = !TeleportClient.CLIENT_CONFIG.hideIcons.get();
            TeleportClient.CLIENT_CONFIG.hideIcons.set(hidden).save();
